...
# TRAIN_DATASET_PATH: "ILSVRC2012_w/train"
# TRAIN_DATASET_LABEL_PATH: "ILSVRC2012_w/train.txt"
# VAL_DATASET_PATH: "ILSVRC2012_w/"
# VAL_DATASET_LABEL_PATH: "ILSVRC2012_w/val_list.txt"

python -m paddle.distributed.launch --gpus="0,1,2,3" \
    eval_linear.py --patch_size 16 \
    --data_path ./ILSVRC2012_w/ \
    --pretrained_weights ./dino_deitsmall16_pretrain_full_checkpoint.pdparams \
